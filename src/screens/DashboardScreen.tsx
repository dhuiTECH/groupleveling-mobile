...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, SafeAreaView, Image, RefreshControl, Dimensions, Platform, ActivityIndicator, Alert,  } from 'react-native';
