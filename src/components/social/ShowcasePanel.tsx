    ...
    >
      ...
      {isLoading && showcaseHunters.length === 0 ? (
        <View style={styles.loaderContainer}>
          ...
          <Text style={styles.loaderText}>SCANNING_STYLE_DATA...</Text>
        </View>
      ) : (
              ...
              >
                {isMonarch && (
                  <View style={styles.monarchBadge}>
                    ...
                    <Text style={styles.monarchBadgeText}>STYLE_MONARCH</Text>
                  </View>
                )}
                ...
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.infoSection}>
                    <View style={styles.nameRow}>
                      <View>
                        <Text style={styles.hunterName}>{hunter.hunter_name || hunter.name}</Text>
                        <Text style={styles.hunterSubtitle}>
                          {hunter.current_title || 'Hunter'} • LV.{hunter.level}
                        </Text>
                      </View>
                      
                      {isOwnCard ? (
                        <View style={styles.ownCardBadge}>
                          <Text style={styles.ownCardText}>YOUR_CARD</Text>
                        </View>
                      ) : (
