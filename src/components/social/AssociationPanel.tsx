      ...
      {user?.association_id ? (
        <>
          ...
          <View style={styles.auraCard}>
            <Text style={styles.auraCardTitle}>ENERGY_WELL_SYNCHRONIZATION</Text>
            <View style={styles.energyWellContainer}>
              ...
              <View style={styles.wellInfo}>
                ...
                <Text style={styles.wellSubtitle}>ASSOCIATION_GOAL_PROGRESS</Text>
              </View>
            </View>
          </View>
          ...
          {applicantCount > 0 && (
            <View style={styles.recruitmentCard}>
              <View style={styles.recruitmentHeader}>
                <Text style={styles.recruitmentTitle}>RECRUITMENT_COMMAND</Text>
                ...
                {pendingApplicants.map((applicant) => (
                  <View key={applicant.id} style={styles.applicantCard}>
                    <View style={styles.applicantLeft}>
                      <LayeredAvatar user={applicant} size={40} onAvatarClick={() => setSelectedAvatar(applicant)} />
          ...
          <View style={styles.rosterCard}>
            <Text style={styles.rosterTitle}>ASSOCIATION_MEMBER_ROSTER</Text>
              ...
              {[
                ...
                <View key={idx} style={styles.rosterItem}>
                  ...
                  <View style={styles.rosterYield}>
                    ...
                    <Text style={styles.yieldLabel}>WEEKLY_YIELD</Text>
                  </View>
                </View>
              ))}
            </View>
        ...
        <>
          ...
          <View style={styles.browseSection}>
            <Text style={styles.sectionHeader}>AVAILABLE_HUNTER_ASSOCIATIONS</Text>
            {availableAssociations.length === 0 ? (
              <View style={styles.emptyBrowse}>
                <Text style={styles.emptyText}>NO_ASSOCIATIONS_FOUND</Text>
                    ...
                    <View key={assoc.id} style={styles.assocCard}>
                      <View style={styles.assocCardTop}>
                        ...
                        <View style={styles.assocInfo}>
                          ...
                          <Text style={styles.assocLeader}>LED_BY: {assoc.leader?.name || 'Unknown'}</Text>
                      ...
                      >
                        <Text style={styles.applyBtnText}>
                          {hasApplied ? 'SIGNAL_TRANSMITTED' : 'REQUEST_SYNC'}
                        </Text>
                      </TouchableOpacity>
                    </View>
                  );
          ...
          {showFoundingForm ? (
            ...
            >
              <View style={styles.formHeader}>
                <Text style={styles.formTitle}>ESTABLISH_HUNTER_ASSOCIATION</Text>
              ...
              <View style={styles.formField}>
                <Text style={styles.fieldLabel}>ASSOCIATION_NAME</Text>
                <TextInput
              ...
              <View style={styles.formField}>
                <Text style={styles.fieldLabel}>SELECT_EMBLEM</Text>
            ...
            <View style={styles.foundingPrompt}>
              <Text style={styles.promptTitle}>ESTABLISH_YOUR_OWN_HUNTER_ASSOCIATION</Text>
              <Text style={styles.promptSubtitle}>Become a President and lead your own guild</Text>
              <TouchableOpacity 
                onPress={() => setShowFoundingForm(true)}
                style={styles.promptBtn}
              >
                <Text style={styles.promptBtnText}>FOUND_ASSOCIATION</Text>
              </TouchableOpacity>
            </View>
          )}
        </>
