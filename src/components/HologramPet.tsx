    ...
    <View style={[styles.container, { transform: [{ scale }] }]}>
      ...
      >
        ...
        <SpriteSheetAnimator
          ...
          frameHeight={512}
          fps={12} // Adjust for desired speed
        />
        
        {/* Hologram Scanlines Overlay */}
         <LinearGradient
          colors={['transparent', 'rgba(6,182,212,0.15)', 'transparent']}
          start={{ x: 0, y: 0 }}
          end={{ x: 0, y: 1 }}
          locations={[0, 0.5, 1]}
        ...
        <MotiView
            ...
            style={[StyleSheet.absoluteFill, { backgroundColor: 'rgba(74, 222, 128, 0.1)' }]}
            pointerEvents="none"
        />
      </MotiView>
...
const styles = StyleSheet.create({
  ...
  glow: {
    ...
    borderRadius: 9999,
    // Blur can be tricky in RN. A simple opacity is often enough.
    opacity: 0.5,
  },
  floatingContainer: {
    width: '100%',
