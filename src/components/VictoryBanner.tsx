    ...
    <View style={styles.container}>
      ...
      <View style={styles.rewardsContainer}>
        <View style={styles.rewardItem}>
          <Image source={expCrystal} style={styles.icon} />
          <Text style={styles.rewardText}>{rewards.exp || 0}</Text>
        </View>
        <View style={styles.rewardItem}>
          <Image source={coinIcon} style={styles.icon} />
          <Text style={styles.rewardText}>{rewards.coins || 0}</Text>
        </View>
        <View style={styles.rewardItem}>
          <Image source={gemIcon} style={styles.icon} />
          <Text style={styles.rewardText}>{rewards.gems || 0}</Text>
        </View>
      </View>
    </View>
  );
