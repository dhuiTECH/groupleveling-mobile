...
const CyberButton = ({ onPress, text, icon: Icon, color = '#2563eb', shadowColor = '#1e40af', disabled, loading }: any) => (
  <TouchableOpacity 
    onPress={onPress} 
    activeOpacity={0.8}
    disabled={disabled}
...
export default function OnboardingView({
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={onAdminLogin} style={styles.adminButton}>
      ...
      >
        <View style={[styles.mainWrapper, step === 'class_path' && { width: '100%', maxWidth: 800 }]}>
          ...
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.subHeader}>INITIAL CONNECTION ESTABLISHED</Text>
          </View>
                ...
                >
                  ...
                  <View style={styles.genderRow}>
                    {['Male', 'Female', 'Non-binary'].map((g) => (
                      <TouchableOpacity 
                        key={g} 
                        onPress={() => setData({...data, gender: g as any})}
                        style={[
                          styles.genderBtn, 
                  ...
                  <View style={styles.avatarContainer}>
                    <View style={styles.avatarCircle}>
                      ...
                      <Image source={getShirtSource()} style={[styles.avatarImg, { zIndex: 10 }]} resizeMode="contain" />
                    </View>
                  </View>
...
const styles = StyleSheet.create({
  ...
  mainWrapper: { width: '100%', maxWidth: 450, alignItems: 'center' },
  ...
  // INPUTS
  inputLabel: { color: '#fff', fontSize: 10, fontWeight: '900', letterSpacing: 2, marginBottom: 8, marginLeft: 4 },
  cyberInput: {
  ...
  genderBtn: {
    flex: 1, paddingVertical: 10, backgroundColor: 'rgba(255,255,255,0.03)',
  ...
  avatarCircle: {
    ...
    backgroundColor: 'rgba(15, 23, 42, 0.9)', // Navy Background
  ...
  linkContainer: { marginTop: 20, width: '100%', alignItems: 'center', borderTopWidth: 1, borderTopColor: 'rgba(30, 58, 138, 0.3)', paddingTop: 16 },
  ...
  // VERIFY STEP
  verifyTitle: { color: '#3b82f6', fontSize: 18, fontWeight: '900', letterSpacing: 1, marginBottom: 8, textAlign: 'center' },
